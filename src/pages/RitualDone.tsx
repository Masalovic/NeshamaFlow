...
${t("ritual:done.labels.duration", "Duration")}: ${mins} ${t(
    "common:units.min",
    "min"
  )}
...
export default function RitualDone() {
  ...
  const ritualTitle = last
    ? tRitualTitle(
        t,
        last.ritualId as RitualId,
        titleForRitualId(last.ritualId)
      )
        ...
        <div className="max-w-[420px] mx-auto">
          ...
          <div className="card p-6 text-center">
            ...
            <p className="mt-1 text-sm text-muted">
              {last ? (
                <span
                  // safe content we build ourselves
            ...
            {/* Actions (bottom row — now grid too) */}
            {last && (
